module github.com/cloudy-sky-software/pulumi-doppler/provider

go 1.21

require (
	github.com/cloudy-sky-software/pulschema 10c1fe440329
	github.com/cloudy-sky-software/pulumi-provider-framework e0ed0163f465
