...
namespace CloudySkySoftware.Pulumi.DopplerNative
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/cloudy-sky-software/pulumi-doppler-native";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("CloudySkySoftware.Pulumi.DopplerNative.version.txt");
    ...
    internal sealed class DopplerNativeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public DopplerNativeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
