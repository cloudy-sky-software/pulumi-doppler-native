...
{
    [DopplerNativeResourceType("doppler-native:projects/v3:ProjectMember")]
    public partial class ProjectMember : global::Pulumi.CustomResource
    {
        ...
        [Output("type")]
        public Output<CloudySkySoftware.Pulumi.DopplerNative.ProjectsV3.Type> Type { get; private set; } = null!;
        ...
        public ProjectMember(string name, ProjectMemberArgs args, CustomResourceOptions? options = null)
            : base("doppler-native:projects/v3:ProjectMember", name, args ?? new ProjectMemberArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectMember(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("doppler-native:projects/v3:ProjectMember", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ProjectMemberArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<CloudySkySoftware.Pulumi.DopplerNative.ProjectsV3.Type> Type { get; set; } = null!;
