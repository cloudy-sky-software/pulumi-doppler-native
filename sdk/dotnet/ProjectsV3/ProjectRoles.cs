...
{
    [DopplerNativeResourceType("doppler-native:projects/v3:ProjectRoles")]
    public partial class ProjectRoles : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public ProjectRoles(string name, ProjectRolesArgs args, CustomResourceOptions? options = null)
            : base("doppler-native:projects/v3:ProjectRoles", name, args ?? new ProjectRolesArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ProjectRoles(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("doppler-native:projects/v3:ProjectRoles", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ProjectRoles Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new ProjectRoles(name, id, options);
        }
    }

    public sealed class ProjectRolesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the role
        /// </summary>
        ...
        public ProjectRolesArgs()
        {
        }
        public static new ProjectRolesArgs Empty => new ProjectRolesArgs();
    }
}
