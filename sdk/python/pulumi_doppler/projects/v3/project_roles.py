...
__all__ = ['ProjectRolesArgs', 'ProjectRoles']

@pulumi.input_type
class ProjectRolesArgs:
...
class ProjectRoles(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a ProjectRoles resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ProjectRolesArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ProjectRoles resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ProjectRolesArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ProjectRolesArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ProjectRolesArgs.__new__(ProjectRolesArgs)
        ...
        super(ProjectRoles, __self__).__init__(
            'doppler-native:projects/v3:ProjectRoles',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ProjectRoles':
        """
        ...
        __props__.__dict__["role"] = None
        return ProjectRoles(resource_name, opts=opts, __props__=__props__)
