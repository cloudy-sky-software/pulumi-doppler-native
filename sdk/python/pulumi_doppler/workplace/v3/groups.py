...
class Groups(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Groups resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(Groups, __self__).__init__(
            'doppler-native:workplace/v3:Groups',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Groups':
        """
