...
class ListEnvironmentsResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> 'outputs.ListEnvironmentsProperties':
...
def list_environments(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListEnvironmentsResult:
    ...
    __ret__ = pulumi.runtime.invoke('doppler-native:environments/v3:listEnvironments', __args__, opts=opts, typ=ListEnvironmentsResult).value
