...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-doppler-native/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("github://api.github.com/cloudy-sky-software/pulumi-doppler-native"))
	version := SdkVersion
